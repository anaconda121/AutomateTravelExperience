        ...
        function drawShip (x, y, a, colour = "white") /* sets default color as white */ {
        ...
        function update() {
            ...
            for (var i = 0; i < lives; i++) {
                lifeColour = exploding && i == lives - 1 ? "red" : "white"; //if ships is exploding, set color of life to red, else have it stay at white
